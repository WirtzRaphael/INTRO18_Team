...
\begin{frame}
\frametitle{Übersicht} % TOC slide
...
%------------------------------------------------
\section{Reflectance} % Section
%------------------------------------------------
\begin{frame}
	\frametitle{Reflectance}
	\begin{itemize}
	\item IR-LED is used as a transmitters
	\item Phototransistor is used as an receiver 
	\end{itemize}
	%\begin{figure}
...
\begin{frame}
	...
	\begin{itemize}
		\item{IR LED und Phototransistor}
...
\end{frame}
%------------------------------------------------
\section{Position encoder} % Section
%------------------------------------------------
\begin{frame}
...
\end{frame}
%------------------------------------------------
\section{Quadrature encoder} % Section
%------------------------------------------------
\begin{frame}
