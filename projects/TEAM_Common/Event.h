...
typedef enum EVNT_Handle {
  ...
  EVNT_SW1_LONG_RELEASED,
  #endif
  #if PL_CONFIG_NOF_KEYS>=2
  EVNT_SW2_PRESSED,
  EVNT_SW2_RELEASED,
  EVNT_SW2_LONG_PRESSED,
  EVNT_SW2_LONG_RELEASED,
  #endif
  #if PL_CONFIG_NOF_KEYS>=3
  EVNT_SW3_PRESSED,
  EVNT_SW3_RELEASED,
  EVNT_SW3_LONG_PRESSED,
  EVNT_SW3_LONG_RELEASED,
  #endif
  #if PL_CONFIG_NOF_KEYS>=4
  EVNT_SW4_PRESSED,
  EVNT_SW4_RELEASED,
  EVNT_SW4_LONG_PRESSED,
  EVNT_SW4_LONG_RELEASED,
  #endif
  #if PL_CONFIG_NOF_KEYS>=5
  EVNT_SW5_PRESSED,
  EVNT_SW5_RELEASED,
  EVNT_SW5_LONG_PRESSED,
  EVNT_SW5_LONG_RELEASED,
  #endif
  #if PL_CONFIG_NOF_KEYS>=6
  EVNT_SW6_PRESSED,
  EVNT_SW6_RELEASED,
  EVNT_SW6_LONG_PRESSED,
  EVNT_SW6_LONG_RELEASED,
  #endif
  #if PL_CONFIG_NOF_KEYS>=7
  EVNT_SW7_PRESSED,
  EVNT_SW7_RELEASED,
  EVNT_SW7_LONG_PRESSED,
  EVNT_SW7_LONG_RELEASED,
  #endif
#endif
